...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFF2E7D32); // Green for scanner
  ...
  static const Color scanFrame = Color(0xFF4CAF50);
  static const Color scanSuccess = Color(0xFF4CAF50);
